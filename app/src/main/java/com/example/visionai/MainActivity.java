...
import com.example.visionai.ml.Modelface;
import com.example.visionai.ml.Modeloflowers;
...
public class MainActivity
    ...
    {    try {
        ...
        Modelface model = Modelface.newInstance(getApplicationContext());
        TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
        inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));
        Modelface.Outputs outputs = model.process(inputFeature0);
